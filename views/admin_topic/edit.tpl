                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group-lg">
                                    <input type="text" name="title" class="form-control" id="Title" placeholder="Title" required autofocus value="{{.Topic.Title}}"></div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <textarea name="content" id="" cols="30" rows="10" class="form-control" placeholder="Content" required autofocus>{{.Topic.Content}}</textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
